...
//        //转成ios4的表情
//        String ios4str = transToIOS5emoji(tmpstr02);
//        byte[] tmp = ios4str.getBytes();
//        //System.out.print(new String(tmp,"utf-8"));
//        for (byte b : tmp) {
//            System.out.print(b);
...
//        System.out.println();
        ...
        String emojiString = emojiAlvin(emojiAndroid);
        System.out.println("取字节码：#" + emojiString + "#");

        String emojiString2 = EmojiParser.emojiText(emojiString);
        System.out.println("emoji通用：#" + emojiString2 + "#");

        String emojiString3 = EmojiParser.demojizedText(emojiString2);
        System.out.println("转回去：#" + emojiString3 + "#");
    }

    public static String emojiAlvin(String source) {
